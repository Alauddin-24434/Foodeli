                         ...
                         <div className="w-full px-4 lg:w-5/12 xl:w-4/12">
                            <div className="mt-10 lg:mt-0">
                                ...
                                <p className="mb-8 text-base text-body-color dark:text-dark-6">
                                    From hearty meals to light bites, we offer a menu designed to
                                    delight every palate. Whether you're dining with family or
                                    celebrating a special moment, we’re here to make it memorable.
                                </p>
                                <a
                                    href="/menu"
