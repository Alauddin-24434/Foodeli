            ...
            <div className="font-sans  mt-20">
                <div className="p-4 lg:max-w-7xl max-w-4xl mx-auto">
                    <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12  p-6 rounded-lg">
                        <div className="lg:col-span-3 w-full lg:sticky top-0 text-center">
                            ...
                            <div className="px-4 py-10 rounded-lg shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative">
                                <img src="/public/images/food.png" alt="Product" className="w-3/4 rounded object-cover mx-auto" />
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="md:flex space-x-2 mt-4 block md:relative">
                                <svg className="w-5 fill-[#F2C94C]" viewBox="0 0 14 13" fill="none"
                            ...
                            <div className="flex flex-wrap gap-4 mt-8">
                                ...
                                <p className="text-gray-400 text-base">$1500 <span className="text-sm ml-1">Tax included</span></p>
                            </div>
                            <div className="md:absolute md:bottom-32">
                                <div className="mt-8">
                                    <h3 className="text-xl font-bold text-gray-800">Quantity: 1</h3>
                                    <div className="flex flex-wrap gap-3 mt-4">
                                        <button className="hover:bg-[#EB0029] bg-slate-300 w-20 p-1 rounded-md">-</button>
                                        <button className="hover:bg-[#EB0029] bg-slate-300 w-20 p-1 rounded-md">+</button>
                                    </div>
                                </div>

                                <div className="flex flex-wrap gap-4 mt-8 ">
                                    <button type="button" className="min-w-[200px] px-4 py-3 bg-[#EB0029] hover:bg-[#EB0029] text-white text-sm font-semibold rounded">Buy now</button>
                    ...
                    <div className="mt-16 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] p-6">
                        <h3 className="text-xl font-bold text-gray-800">Food information</h3>
                    ...
                    <div className="p-6">
                                        ...
                                        <div className="pt-11 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto">
                                            ...
                                            <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <h6 className="font-semibold text-lg leading-8 text-[#EB0029] ">John Watson</h6>
                                                </div>
                                        ...
                                        <div className="pt-8 max-xl:max-w-2xl max-xl:mx-auto">
                                            ...
                                            <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <h6 className="font-semibold text-lg leading-8 text-[#EB0029]">Robert Karmazov</h6>
                                                </div>
                                                <p className="font-normal text-lg leading-8 text-gray-400">Nov 01, 2023</p>
                                            </div>
                        ...
                        {/* reviews  addd form*/}
                        <div className="flex flex-col  p-8  rounded-xl lg:p-12  bg-amber-50 ">
                                ...
                                <div className="flex flex-col items-center py-6 space-y-3">
                                    ...
                                    <div className="flex space-x-3">
                                        <button type="button" title="Rate 1 stars" aria-label="Rate 1 stars">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-10 h-10 text-[#F2C94C]">
