...
const FoodReviews = () => {
    return (
        <div>
            <div className="text-gray-600 dark:text-gray-300 mt-20 dark:bg-gray-900" id="reviews">
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                    ...
                    <div className="md:columns-2 lg:columns-3 gap-8 space-y-8">
                        ...
                        <div
                            className="aspect-auto p-8 border border-[#F2C94C] rounded-3xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
