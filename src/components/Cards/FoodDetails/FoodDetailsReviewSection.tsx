...
import { useAddFoodReviewMutation } from "../../../redux/features/foodItems/foodItemsApi";
import { IFoodItem } from "../../../interface/types";

interface FoodDetailsReviewSectionProps {
    productId: string;
    foodDetails: IFoodItem;
}

const FoodDetailsReviewSection: React.FC<FoodDetailsReviewSectionProps> = ({ productId, foodDetails }) => {
